...
export default function CartSidebar({ isOpen, onClose }: CartSidebarProps) {
  ...
  return (
    <>
      ...
      {/* Cart Sidebar */}
      <div
        className={`fixed top-0 right-0 h-full w-full sm:max-w-md bg-yellow-400 border-l-8 border-black shadow-[-12px_0px_0px_0px_rgba(0,0,0,1)] z-50 transform transition-transform duration-300 ease-in-out ${isOpen ? "translate-x-0" : "translate-x-full"
          }`}
      >
        {/* Header */}
                ...
                <div className="flex items-center justify-between mt-3 sm:mt-4">
                  <div className="flex items-center space-x-2">
                    <Button
                      ...
                      className="bg-cyan-400 hover:bg-cyan-500 text-black border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:shadow-[1px_1px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[1px] hover:translate-y-[1px] transition-all p-2 sm:p-1"
                    >
                    ...
                    <Button
                      onClick={() => updateQuantity(item.id, item.quantity + 1)}
                      className="bg-lime-400 hover:bg-lime-500 text-black border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:shadow-[1px_1px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[1px] hover:translate-y-[1px] transition-all p-2 sm:p-1"
                    >
        ...
        {/* Cart Summary */}
        {cartItems.length > 0 && (
          <div className="border-t-4 border-black bg-cyan-400 p-4 sm:p-6">
